...
<form action="{{ route('adminregister') }}" method="POST" class="form">
    @csrf
    ...
    <h1 class="flex justify-center font-semibold -mt-4 mb-4 text-3xl">register</h1>
    ...
    <p class="p">Don't have an account? <a href="/admin/login"><span class="span">Register</span></a>
