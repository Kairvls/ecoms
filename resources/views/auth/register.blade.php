...
<form id="registerForm" action="{{ route('register') }}" method="POST" class="form">
    ...
    <h1 class="flex justify-center font-semibold text-black -mt-4 mb-4 text-3xl">ʀᴇɢɪꜱᴛᴇʀ</h1>
    ...
    <div class="flex-column">
      ...
      <div class="inputForm">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="text-black bi bi-person" viewBox="0 0 16 16">
  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/>
</svg>
        <input placeholder="Enter your Fullname" class="text-black input" name="fullname" type="text">
      </div>
    ...
    <div class="flex-column">
      ...
      <div class="inputForm">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="text-black bi bi-briefcase" viewBox="0 0 16 16">
  <path d="M6.5 1A1.5 1.5 0 0 0 5 2.5V3H1.5A1.5 1.5 0 0 0 0 4.5v8A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-8A1.5 1.5 0 0 0 14.5 3H11v-.5A1.5 1.5 0 0 0 9.5 1zm0 1h3a.5.5 0 0 1 .5.5V3H6v-.5a.5.5 0 0 1 .5-.5m1.886 6.914L15 7.151V12.5a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5V7.15l6.614 1.764a1.5 1.5 0 0 0 .772 0M1.5 4h13a.5.5 0 0 1 .5.5v1.616L8.129 7.948a.5.5 0 0 1-.258 0L1 6.116V4.5a.5.5 0 0 1 .5-.5"/>
</svg>
        <input placeholder="Enter your Email" class="text-black input" name="email" type="email">
      </div>
      <div class="flex-column">
      ...
      <div class="inputForm relative">
        ...
        <input placeholder="Enter your Password" id="password" class="text-black input" name="password" type="password">
        <button type="button" onclick="togglePassword()" class="text-black absolute inset-y-0 right-2 mb-3 flex items-center">
    ...
    <div class="block grow">
      ...
      <div class="inputForm">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="-64 0 512 512" height="20"><path d="m336 512h-288c-26.453125 0-48-21.523438-48-48v-224c0-26.476562 21.546875-48 48-48h288c26.453125 0 48 21.523438 48 48v224c0 26.476562-21.546875 48-48 48zm-288-288c-8.8125 0-16 7.167969-16 16v224c0 8.832031 7.1875 16 16 16h288c8.8125 0 16-7.167969 16-16v-224c0-8.832031-7.1875-16-16-16zm0 0"></path><path d="m304 224c-8.832031 0-16-7.167969-16-16v-80c0-52.929688-43.070312-96-96-96s-96 43.070312-96 96v80c0 8.832031-7.167969 16-16 16s-16-7.167969-16-16v-80c0-70.59375 57.40625-128 128-128s128 57.40625 128 128v80c0 8.832031-7.167969 16-16 16zm0 0"></path></svg>        
        <input placeholder="Enter your Password" class="text-black input" name="password_confirmation" type="password">
      </div>

      <div class="flex-column">
      <label>Address </label></div>
      <div class="inputForm">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="text-black bi bi-geo-alt" viewBox="0 0 16 16">
  <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A32 32 0 0 1 8 14.58a32 32 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10"/>
  <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4m0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
</svg>
        <input placeholder="Enter your Address" class="text-black input" name="address" type="text">
      </div>

      <div class="flex-column">
      <label>Contact Number </label></div>
      <div class="inputForm">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="text-black bi bi-telephone-plus" viewBox="0 0 16 16">
  ...
  <path fill-rule="evenodd" d="M12.5 1a.5.5 0 0 1 .5.5V3h1.5a.5.5 0 0 1 0 1H13v1.5a.5.5 0 0 1-1 0V4h-1.5a.5.5 0 0 1 0-1H12V1.5a.5.5 0 0 1 .5-.5"/>
        ...
        <input placeholder="Enter your Number" class="text-black input" name="contact_number" type="text">
      </div>
    ...
    <p class="p">Already have an Account? <a href="{{ route('login') }}"><span class="span">Log In</span></a>
        ...
        $.ajax({
            ...
            success: function(response) {
                Swal.fire({
                    ...
                    window.location.href = "{{ route('login') }}"; // Redirect after alert
                });
            },
